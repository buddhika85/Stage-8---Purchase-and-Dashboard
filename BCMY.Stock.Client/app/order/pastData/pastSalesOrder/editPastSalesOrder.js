...
(function () {
    ...
    function wireCommands(vm, $http, contactResource, customerSupplierResource, $location) {
        ...
        $('#selectCustSupp').change(function () {
            onCompanyDDLSelection($http, contactResource, vm);
        });

        // on a contact name selection
        $('#selectContact').change(function () {
            onContactDDLSelection($http, customerSupplierResource, vm);
        });
    ...
    function InsertOrderLine($http, vm) {
        ...
        if (isValid) {
            ...
            var orderId = $('#orderId').val();
            debugger
            var pastDate = vm.searchObject.pastDate; //new Date(vm.searchObject.pastDate);
    ...
    function ValidateNegotiation() {
        ...
        /* stock count validation is not necessary for the past orders */
